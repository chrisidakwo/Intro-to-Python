"""Working with and handling exceptions in Python

Reworking our "DayOfTheWeek" sample to include functions
and exception blocks

Exception blocks are used to catch and handle errors in our program.
We do this to avoid our program crashing, malfunctioning or introducing
bugs into other parts of the program.

They are mostly used when handling user inputs, making database operations,
converting data types, processing data, and in cases you deem fit
"""
import sys
